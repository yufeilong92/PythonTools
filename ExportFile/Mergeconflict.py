...
class Mergeconflict(MainQuit):
    ...
    def showDialog(self, mainRoot):
        ...
        Button(master=root, text="获取", font=mFont, relief=mRlief, command=lambda: self.
               adbSelectSheeet(mOneRow, selectPathOneTv, oneSheetCbb, True)).grid(row=rowNum, column=2, sticky=mSticky,
                                                                                  pady=4)
        ...
        Button(master=root, text="选择", font=mFont, relief=mRlief, command=lambda: self.
               adbSelectFileOne(selectPathTwoTv, mTwoSheet, mTwoRow, False)).grid(row=rowNum, column=2, sticky=mSticky,
                                                                                  pady=4)
        ...
        Button(master=root, text="获取", font=mFont, relief=mRlief, command=lambda: self.
               adbSelectSheeet(mTwoRow, selectPathTwoTv, twoSheetCbb, False)).grid(row=rowNum, column=2, sticky=mSticky,
                                                                                   pady=4)
        ...
        Button(master=root, text="查重并追加文件1", font=mFont,
               command=lambda: self.adbSave(selectPathOneTv, oneSheetCbb, oneRowCbb, selectPathTwoTv, twoSheetCbb,
                                            twoRowCbb, saveNewPathTv, saveName)).grid(row=rowNum, column=1,
                                                                                      sticky=mSticky, pady=4)
